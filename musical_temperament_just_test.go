...
func TestNewMTemperamentJust(t *testing.T) {
	...
	tu.AssertEq(roundFloat(o4.Note(Cis).ExactFrequency(), 2), 275, t)
	tu.AssertEq(roundFloat(o4.Note(D).ExactFrequency(), 2), 293.33, t)
	tu.AssertEq(roundFloat(o4.Note(Dis).ExactFrequency(), 2), 305.56, t)
	tu.AssertEq(roundFloat(o4.Note(E).ExactFrequency(), 2), 325.93, t)
	tu.AssertEq(roundFloat(o4.Note(F).ExactFrequency(), 2), 343.75, t)
	tu.AssertEq(roundFloat(o4.Note(Fis).ExactFrequency(), 2), 366.67, t)
	tu.AssertEq(roundFloat(o4.Note(G).ExactFrequency(), 2), 391.11, t)
	tu.AssertEq(roundFloat(o4.Note(Gis).ExactFrequency(), 2), 407.41, t)
	tu.AssertEq(roundFloat(o4.Note(A).ExactFrequency(), 2), 440, t)
	tu.AssertEq(roundFloat(o4.Note(Ais).ExactFrequency(), 2), 458.33, t)
	tu.AssertEq(roundFloat(o4.Note(B).ExactFrequency(), 2), 488.89, t)
	...
	tu.AssertEq(roundFloat(fis3.ExactFrequency(), 2), 183.33, t)
}
...
func TestMTemperamentJustCA440(t *testing.T) {
	...
	tu.AssertEq(roundFloat(oct4.Note(A).ExactFrequency(), 2), roundFloat(440, 2), t)
	tu.AssertEq(roundFloat(oct4.Note(Ais).ExactFrequency(), 2), roundFloat(475.2, 2), t)
	tu.AssertEq(roundFloat(oct4.Note(B).ExactFrequency(), 2), roundFloat(495.0, 2), t)
}
